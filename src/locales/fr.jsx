const fr = {
  ...
  projectList: {
    ...
    leaderPlaceholder: 'Visa du chef de projet',
    memberPlaceholder: 'Visa du membre',
    startDateFrom: 'Date début (De)',
    startDateTo: 'Date début (À)',
    endDateFrom: 'Date fin (De)',
    endDateTo: 'Date fin (À)',
  },
  projectForm: {
